...
const DeleteTeacherCourseForm = ({ open, setOpen, rowData }) => {
    ...
    >
      <div className="space-y-4">
        ...
        <div className="p-4 bg-gray-50 rounded-lg">
          <p className="text-sm text-gray-600 mb-2">الموضوع الذي سيتم حذفه:</p>
...
export default DeleteTeacherCourseForm;
