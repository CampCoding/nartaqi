...
//   // Update the addMcqOption function
// const addMcqOption = () => {
...
// // Update the removeMcqOption function to prevent removal if it would leave less than 2 options
...
// // Update the validateQuestionBeforeSubmit function
...
// // You can also add a helper function to highlight empty options
// const highlightEmptyOptions = () => {
//   const emptyIndices = mcqOptions
//     .map((opt, idx) => (!opt.answer?.trim() ? idx : -1))
//     .filter(idx => idx !== -1);
...
//                 <Select
//                   style={{ width: "100%", height: "105%", padding: "20px 0px" }}
                      ...
                      <div className="space-y-5">
                              ...
                              >
                                ...
                                <div className="px-6 pb-6 space-y-6 border-t border-gray-100">
                                  <div>
                                    ...
                                    />
                                    {isEmpty && (
                                      <p className="text-red-600 text-xs mt-2">هذا الحقل مطلوب</p>
                                    )}
                                  </div>
                        ...
                        <div className="flex justify-center pt-4">
                          <button
                            ...
                            className="inline-flex items-center gap-3 px-6 py-3 text-sm font-medium text-blue-700 bg-blue-50 rounded-2xl hover:bg-blue-100 hover:shadow-md transition-all shadow-sm border border-blue-200 disabled:opacity-50 disabled:cursor-not-allowed"
                          >
                            <PlusIcon className="w-5 h-5" />
                            إضافة خيار جديد
                            {mcqOptions.length >= 10 && (
                              <span className="text-xs text-red-600">(الحد الأقصى 10)</span>
                            )}
                          </button>
                        </div>
                      </div>
