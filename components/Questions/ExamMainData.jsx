...
export default function ExamMainData({ examData: editExamData, examid }) {
  ...
  useEffect(() => {
    if(lessonId) {
      dispatch(handleGetAllExamByLessonId({body : {
        lesson_id : lessonId
      }}))
    }
  },[lessonId])
  ...
  const addOrUpdateQuestion = async () => {
      ...
      switch (questionType) {
        case "mcq":
          if (mcqSubType === "general") {
            ...
            payload = {
              ...
              instructions: questionInstruction || "اختر الإجابة الصحيحة", // Use instruction
        ...
        case "essay":
          payload = {
            id: editingQuestion.id,
            question_text: currentQuestion,
            instructions: questionInstruction || "أجب عن السؤال التالي", // Use instruction
            exam_section_id: selectedSectionId,
        ...
        case "complete":
          ...
          payload = {
            ...
            instructions: questionInstruction || "أكمل الجملة التالية", // Use instruction
            exam_section_id: selectedSectionId,
    ...
    const baseQuestion = {
      ...
      question_text: currentQuestion,
      instructions: questionInstruction || "Instructions", // Use instruction
      exam_section_id: selectedSectionId,
    };
