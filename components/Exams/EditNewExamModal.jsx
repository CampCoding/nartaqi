...
const QUESTION_TYPES = [
  ...
  { value: "passage", label: "قطعة قراءة" }, // تأكد من وجود هذا النوع
];
...
function AddNewExamModal({
  ...
  useEffect(() => {
    console.log("خيارات أنواع الأسئلة:", questionTypeOptions);
  }, [questionTypeOptions]);
                    ...
                    {fields.map(({ key, name, ...restField }, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            <Select
                              options={questionTypeOptions} // استخدام المتغير الصحيح
                                    ...
                                    <div className="flex items-center justify-between mb-2">
                                      ...
                                      <Space>
                                        <Select
                                          defaultValue="mcq"
                                          style={{ width: 220 }}
                                          options={questionTypeOptions.filter((t) => t.value !== "passage")} // منع إضافة قطعة داخل قطعة
                                      ...
                                      {subFields.map(({ key: skey, name: sName, ...sRest }, sIdx) => {
                                        ...
                                        return (
                                          ...
                                          >
                                            ...
                                            >
                                              <Select
                                                options={questionTypeOptions.filter((t) => t.value !== "passage")} // منع تحويل السؤال الفرعي إلى قطعة
