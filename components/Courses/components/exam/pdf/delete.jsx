...
import { handleDeleteExamPdf } from "@/lib/features/examSlice";
...
export default function DeletePdfModal({ open, setOpen }) {
  const dispatch = useDispatch();
  const deleteData = async () => {
    dispatch(handleDeleteExamPdf({ body: open })).then((payload) => {
