...
import { handleDeleteLive, handleMarkLiveAsFinish } from "@/lib/features/livesSlice";
...
export default function FinishLiveModal({ open, setOpen }) {
  const dispatch = useDispatch();
  const deleteData = async () => {
    dispatch(handleMarkLiveAsFinish({ body: open })).then((payload) => {
      ...
      if (
        ...
        toast.success("Live Finished successfully");
        dispatch(
