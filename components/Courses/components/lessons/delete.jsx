...
import { handleDeleteRoundLessons } from "@/lib/features/lessonSlice";
...
export default function DeleteLessonModal({ open, setOpen }) {
  const dispatch = useDispatch();
  const deleteData = async () => {
    dispatch(handleDeleteRoundLessons({ body: open })).then((payload) => {
