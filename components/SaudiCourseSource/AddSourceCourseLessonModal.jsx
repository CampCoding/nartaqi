...
export default function AddSourceCourseLessonModal({openAddLesson,VIDEO_SOURCES,beforeUploadVideo, beforeUploadPdf , normFile,lessonForm , foundationStages , setOpenAddLesson , submitLesson , savingLesson }) {
  return (
    <Modal
    title="قسم درس"
    open={openAddLesson}
