...
import { handleGetAllGeneralRatings } from "../../../lib/features/ratingSlice";
...
export default function RatingPage() {
  ...
  const {general_rating_loading , general_rating_list} = useSelector(state => state?.rating);
  ...
  function handleGetAllData() {
    dispatch(handleGetAllGeneralRatings())
  }
