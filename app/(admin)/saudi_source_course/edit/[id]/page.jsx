...
import { Form, Button, message, Upload, Divider } from "antd";
    ...
    if (subject) {
      ...
      form.setFieldsValue({
        ...
        availableRange: subject.availableRange
          ? [dayjs(subject.availableRange[0]), dayjs(subject.availableRange[1])]
          : undefined,
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                تعديل الدورة التعليمية مع تحديث الجدولة والمحتوى
              </p>
            </div>
          </div>
