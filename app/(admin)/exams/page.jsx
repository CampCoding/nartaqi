          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <Button
                ...
                className={`${showFilters ? 'bg-blue-50 text-blue-600 border-blue-200' : 'bg-gray-50 text-gray-600 border-gray-200'} transition-all duration-300`}
              >
        ...
        <Modal
          ...
          title={
            <div className="flex items-center gap-3 pb-4 border-b border-gray-100">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800">معاينة الاختبار</h3>
            ...
            <div className="space-y-6 p-6">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-blue-50 rounded-xl">
                  ...
                  <p className="text-xl font-bold text-blue-700">{selectedExam.questionsCount}</p>
                </div>
                <div className="text-center p-4 bg-green-50 rounded-xl">
                  <Clock className="w-6 h-6 text-green-600 mx-auto mb-2" />
                  <p className="text-sm text-green-600 font-medium">المدة</p>
                  <p className="text-xl font-bold text-green-700">{selectedExam.duration} د</p>
                </div>
                <div className="text-center p-4 bg-purple-50 rounded-xl">
                  <Users className="w-6 h-6 text-purple-600 mx-auto mb-2" />
                  <p className="text-sm text-purple-600 font-medium">المشاركون</p>
                  <p className="text-xl font-bold text-purple-700">{selectedExam.participantsCount}</p>
                </div>
                <div className="text-center p-4 bg-orange-50 rounded-xl">
                  <Trophy className="w-6 h-6 text-orange-600 mx-auto mb-2" />
                  <p className="text-sm text-orange-600 font-medium">الدرجات</p>
                  <p className="text-xl font-bold text-orange-700">{selectedExam.totalMarks}</p>
                </div>
              </div>
              
              <div className="bg-gray-50 rounded-xl p-4">
                <h4 className="font-semibold text-gray-800 mb-2">وصف الاختبار</h4>
                <p className="text-gray-600">{selectedExam.description}</p>
              </div>
              
              <div className="flex justify-end gap-3">
                <Button onClick={() => setPrevModal(false)}>
                  إغلاق
                </Button>
                <Button type="primary" className="bg-gradient-to-r from-green-500 to-emerald-500 border-0">
          ...
          <div className="space-y-4" dir="rtl">
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm text-gray-500">
                {selectedExam?.participantsCount} مشارك • {selectedExam?.questionsCount} سؤال
              </p>
            </div>
